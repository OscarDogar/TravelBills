...
namespace Soccer.Common.Services
{
    public class ApiService : IApiService
    {
        ...
        public async Task<Response> NewTripDetailAsync(string urlBase, string servicePrefix, string controller, TripDetailRequest tripDetailRequest, string tokenType, string accessToken)
        {
            try
            {
        ...
        public async Task<Response> NewTripAsync(string urlBase, string servicePrefix, string controller, TripRequest tripRequest, string tokenType, string accessToken)
        {
            try
            {
